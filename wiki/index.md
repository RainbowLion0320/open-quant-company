...
> Last updated: 2026-05-14 | Total pages: 13 ( + log + schema )
...
## Decisions
- [[ai-automation-roadmap]] — **AI自动化框架路线图**：ML基础设施→R&D循环→Agent驱动，三阶段演进
- [[duckdb-migration]] — SQLite→DuckDB→Parquet存储三阶段演进，无锁并发
