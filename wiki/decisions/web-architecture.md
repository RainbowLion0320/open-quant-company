...
- 新增: `/api/system/deepseek-usage` (官方余额 + 本项目 DeepSeek API response usage ledger)
- 前端: ActivityMonitor.vue, CPU/MEM/DISK + DeepSeek 项目用量 + Top 进程 + API Health + Cron Jobs
- DeepSeek 用量来源: 官方余额 API + 本项目 API response usage ledger，不依赖 Chrome CDP/Cookie。
