...
- Actual advanced desk reasoning, broad tool execution, streaming updates, background scheduled report cadence, and live submission/reconciliation are not yet implemented.
