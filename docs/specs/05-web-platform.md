...
| 路由 | 页面 | 功能 |
|------|------|------|
| `/` | CEO Office | 用户作为 CEO 与 Data / Research / Risk / Execution / Engineering / Reporting desk agents 对话，在消息内查看证据并处理需要审批的行动 |
