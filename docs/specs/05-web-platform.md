...
这些端点当前覆盖 Phase 1 foundation runtime、Phase 2 CEO Office 基础页面、Phase 3 handoff foundation、报告 artifact foundation 和 live readiness foundation：本地 ledger、会话 metadata 更新、审批状态、action expiry、证据解析、desk registry、deterministic desk response、固定 registry 命令的安全/已批准 dispatch、跨 desk handoff ledger、handoff resolve、transparent memory inspect/export/prune/clear、evidence-cited CEO reports、默认首页、会话消息写入、审批队列、handoff 面板、action detail、run history、report cards、MiniQMT/QMT readiness card 和 evidence detail 展示。Advanced desk reasoning、广义 tool execution、streaming、完整报告节奏和 live order submission/reconciliation 仍按 [07-agent-company-os.md](07-agent-company-os.md) 分阶段实现；实现前不得在 Web 端调用假端点或展示伪成功。
