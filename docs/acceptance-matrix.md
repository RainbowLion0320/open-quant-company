...
| 5.9 | CodeGraph 代码图谱 | `web/api/routes/codegraph.py`, `web/api/services/codegraph.py` | `test_codegraph_contracts.py` | `/system?tab=codegraph` → `CodeGraph.vue` | 模块/文件/符号图谱可下钻，索引状态和显式 Sync/Rebuild 可用 | OK | — |
