...
设计理念:
  写: pd.DataFrame.to_parquet() → var/store/signals/{strategy}.parquet
...
from data.storage.db import get_db, reset_db
...
def list_strategies() -> List[dict]:
    ...
    from data.strategy.catalog import get_enabled_strategies, get_strategy_label
