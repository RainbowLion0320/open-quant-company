...
架构:
  var/store/signals/{strategy}.parquet  — 策略信号
...
_DUCKDB_PATH = _HUB.db_path("quant_results.duckdb")
_SQLITE_PATH = _HUB.db_path("quant_results.db")
...
def _register_views(db: Database):
    """将 DataHub store 下所有 Parquet 文件映射为 DuckDB 视图。
    ...
    # ── 多资产存储视图 (Phase 4.1) ──
    # 扫描 store/{asset_type}/signals/ 下的信号文件
