...
def _provider_request_config(provider_cfg: dict[str, Any], use_case_cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "reasoning_provider_parameter": str(request.get("reasoning_provider_parameter") or ""),
        "reasoning_provider_value": str(request.get("reasoning_provider_value") or ""),
...
def _blocked_runtime(use_case: str, provider: str, model: str, reason: str) -> dict[str, Any]:
    return {
        ...
        "timeout_seconds": 20.0,
        "reasoning_level": "",
        "reasoning_provider_parameter": "",
        "reasoning_provider_value": "",
        "context_window_tokens": 0,
        "extra_body": {},
        "block_reason": reason,
    }
...
def resolve_llm_use_case(use_case: str, *, provider: str | None = None, model: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "reasoning_provider_parameter": request_cfg["reasoning_provider_parameter"],
        "reasoning_provider_value": request_cfg["reasoning_provider_value"],
