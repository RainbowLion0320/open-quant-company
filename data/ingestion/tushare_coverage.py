...
def build_tushare_coverage(hub: DataHub, symbols: list[str], trade_days: list[str]) -> dict[str, dict[str, object]]:
    return {
        ...
        "income_statement": symbol_file_coverage(hub.dimension_root("income_statement"), symbols),
        "balance_sheet": symbol_file_coverage(hub.dimension_root("balance_sheet"), symbols),
        "cashflow_statement": symbol_file_coverage(hub.dimension_root("cashflow_statement"), symbols),
