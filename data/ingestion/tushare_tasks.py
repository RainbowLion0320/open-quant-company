...
BACKFILL_TASKS: list[BackfillTask] = [
    ...
    BackfillTask("income_statement", "Tushare 完整利润表", "p0", direct="income_statement"),
    BackfillTask("balance_sheet", "Tushare 完整资产负债表", "p0", direct="balance_sheet"),
    BackfillTask("cashflow_statement", "Tushare 完整现金流量表", "p0", direct="cashflow_statement"),
