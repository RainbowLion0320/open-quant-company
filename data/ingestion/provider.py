...
Usage:
    from data.ingestion.provider import get_provider, AKShareAdapter, TushareAdapter
...
class AKShareAdapter(ProviderAdapter):
    ...
    _DISPATCH: dict[str, tuple[str, str, dict]] = {
        "ohlcv_daily":       ("data.ingestion.fetcher", "get_stock_daily",    {}),
        "financial_summary": ("data.market.financials", "get_financial_summary", {}),
        "macro_cpi":         ("data.ingestion.fetchers.macro", "MacroFetcher", {"method": "fetch_indicator", "indicator": "cpi"}),
        "macro_gdp":         ("data.ingestion.fetchers.macro", "MacroFetcher", {"method": "fetch_indicator", "indicator": "gdp"}),
        "macro_lpr":         ("data.ingestion.fetchers.macro", "MacroFetcher", {"method": "fetch_indicator", "indicator": "lpr"}),
        "macro_money_supply":("data.ingestion.fetchers.macro", "MacroFetcher", {"method": "fetch_indicator", "indicator": "money_supply"}),
        "macro_pmi":         ("data.ingestion.fetchers.macro", "MacroFetcher", {"method": "fetch_indicator", "indicator": "pmi"}),
        "macro_ppi":         ("data.ingestion.fetchers.macro", "MacroFetcher", {"method": "fetch_indicator", "indicator": "ppi"}),
        "macro_shibor":      ("data.ingestion.fetchers.macro", "MacroFetcher", {"method": "fetch_indicator", "indicator": "shibor"}),
        "bond_treasury_yields": ("data.market.assets.bond", "BondAsset",       {"method": "_load_yields"}),
    }
