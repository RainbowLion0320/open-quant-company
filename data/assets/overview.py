...
ASSET_ADAPTERS = {
    "stock": "data.assets.stock:StockAsset",
    "etf": "data.assets.etf:ETFAsset",
    "bond": "data.assets.bond:BondAsset",
    "futures": "data.assets.futures:FuturesAsset",
    "crypto": "data.assets.crypto:CryptoAsset",
}
