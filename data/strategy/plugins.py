...
Strategy metadata still lives in ``config/settings.yaml`` via ``data.strategy.catalog``;
...
from data.strategy.catalog import get_enabled_strategies, get_strategy, list_strategy_names
from data.storage.results_db import (
    get_buffett_meta,
