...
def test_quality_value_backtest_inputs_are_cut_to_rebalance_date(monkeypatch):
    from backtest import candidate_alpha_features
    ...
    candidate_alpha_features.quality_inputs.cache_clear()

    inputs = candidate_alpha_features.quality_inputs("000001", 1, "2020-06-01")
