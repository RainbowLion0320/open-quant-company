...
DESKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "mandate": "Strategy evidence, technical/sentiment/fundamental/factor/ML analysis, backtests, OOS, IC/ICIR, and promotion proposals.",
        "capabilities": [
            "technical_analysis",
            "sentiment_analysis",
        ...
        "handoff_targets": ["data", "portfolio", "risk", "reporting"],
        "default_policy": "approval_required_for_official_backtests",
        "status": "available",
    },
    {
        "desk_id": "portfolio",
        "display_name": "Portfolio Desk",
        "mandate": "Portfolio-level investment decisions, target exposure review, rebalance cadence, strategy mix, and position-sizing evidence.",
        "allowed_tools": [
            "astroq.strategy.catalog",
            "astroq.strategy.compete",
        ...
        "forbidden_actions": ["write_data", "live_order", "code_change"],
        "evidence_required": ["strategy_evidence", "alpha_evidence", "lifecycle_readiness", "execution_readiness"],
        "handoff_targets": ["research", "risk", "execution", "reporting"],
        "default_policy": "read_only_portfolio_review",
        "status": "available",
    },
    {
        "desk_id": "risk",
        ...
        "handoff_targets": ["data", "research", "portfolio", "execution", "reporting"],
    ...
    },
    {
        ...
        "handoff_targets": ["portfolio", "risk", "reporting"],
    ...
    },
    {
        ...
        "handoff_targets": ["data", "research", "portfolio", "risk", "reporting"],
    ...
    },
    {
        ...
        "handoff_targets": ["data", "research", "portfolio", "risk", "execution", "engineering"],
